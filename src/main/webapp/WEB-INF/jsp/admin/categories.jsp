    ...
    <div class="container-fluid">
      <div class="sidebar">
        <div class="well">
          ...
          <ul>
            <li>
              <a id="agregar-categoria-link" href="#" title="${i18n['libros.agregarCategoria']}"
                 onclick="UVAQ.eLibrary.libros.mostrarFormularioCategoria('nuevo')">
            ...
            <li>
              <a id="editar-categoria-link" href="#" title="${i18n['libros.editarCategoria']}"
                 onclick="UVAQ.eLibrary.libros.mostrarFormularioCategoria('editar')">
