...
import mx.edu.uvaq.elibrary.presentacion.controlador.CargaLibroControlador;
import mx.edu.uvaq.elibrary.presentacion.controlador.LibrosControlador;
 ...
 * @author arcesino
 */
public class LibroFormaFiltro implements Filter {
      ...
      try {
        ...
        if (fechaPublicacion != null) {
          try {
            ...
            Logger.getLogger(LibroFormaFiltro.class.getName()).log(Level.SEVERE, null, ex);
          }
        }
